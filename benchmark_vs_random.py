...
agentes_a_evaluar = [
    ("Agents.StevenAgent.GeneticAgent", None), # Por ejemplo, si quieres evaluar el agente AdrianHerasAgent, que está en Agents.AdrianHerasAgent sin parámetros adicionales
