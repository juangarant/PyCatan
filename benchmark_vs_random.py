...
agentes_a_evaluar = [
    ("Agents.prueba1v2optimizado.prueba1v2optimizado", None), # Por ejemplo, si quieres evaluar el agente AdrianHerasAgent, que está en Agents.AdrianHerasAgent sin parámetros adicionales
